...
import { Play, Pause, Volume2, VolumeX, Maximize, RotateCcw, BookOpen, Video, FileText, ExternalLink } from 'lucide-react';
      ...
      tutorials: [
        {
          ...
          resources: [
            { title: 'Quick Start Guide', type: 'pdf', url: '/resources/quickstart.pdf' },
            { title: 'Platform Overview', type: 'article', url: '/help/overview' }
          ]
        },
        {
          id: 'dashboard-tour',
          ...
          resources: [
            { title: 'Dashboard Guide', type: 'pdf', url: '/resources/dashboard.pdf' }
          ]
        },
        {
          id: 'account-setup',
          ...
          resources: [
            { title: 'Account Setup Checklist', type: 'pdf', url: '/resources/setup-checklist.pdf' }
          ]
        }
      ]
    },
      ...
      tutorials: [
        {
          ...
          duration: '6:30',
          type: 'video',
          description: 'Learn how to create compelling content with AI assistance',
          videoUrl: '/tutorials/ai-content-basics.mp4',
          transcript: `AI content generation is at the heart of AffiliateFlow...`,
          resources: [
            { title: 'Content Templates', type: 'download', url: '/templates/content-templates.zip' },
            { title: 'Writing Best Practices', type: 'article', url: '/help/writing-tips' }
          ]
        },
        {
          id: 'seo-optimization',
          ...
          resources: [
            { title: 'SEO Checklist', type: 'pdf', url: '/resources/seo-checklist.pdf' },
            { title: 'Keyword Research Guide', type: 'article', url: '/help/keyword-research' }
          ]
        },
        {
          id: 'content-calendar',
          ...
          resources: [
            { title: 'Content Calendar Template', type: 'download', url: '/templates/calendar-template.xlsx' }
          ]
        }
      ]
    },
      ...
      tutorials: [
        {
          ...
          resources: [
            { title: 'Platform Setup Guide', type: 'pdf', url: '/resources/platform-setup.pdf' }
          ]
        },
        {
          ...
          duration: '7:20',
          type: 'video',
          description: 'Set up automated posting schedules across all platforms',
          videoUrl: '/tutorials/automated-posting.mp4',
          transcript: `Automated posting saves time and ensures consistent presence...`,
          resources: [
            { title: 'Posting Schedule Templates', type: 'download', url: '/templates/posting-schedules.zip' }
          ]
        },
        {
          ...
          resources: [
            { title: 'Engagement Strategies', type: 'article', url: '/help/engagement-strategies' }
          ]
        }
      ]
    },
      ...
      tutorials: [
        {
          ...
          duration: '5:00',
          type: 'video',
          description: 'Create and customize your affiliate links for better tracking',
          videoUrl: '/tutorials/link-creation.mp4',
          transcript: `Proper link creation and tracking is essential for measuring success...`,
          resources: [
            { title: 'Link Tracking Guide', type: 'pdf', url: '/resources/link-tracking.pdf' }
          ]
        },
        {
          ...
          resources: [
            { title: 'Optimization Checklist', type: 'pdf', url: '/resources/optimization-checklist.pdf' }
          ]
        }
      ]
    },
      ...
      tutorials: [
        {
          ...
          resources: [
            { title: 'Analytics Guide', type: 'pdf', url: '/resources/analytics-guide.pdf' }
          ]
        },
        {
          id: 'custom-reports',
          ...
          resources: [
            { title: 'Report Templates', type: 'download', url: '/templates/report-templates.zip' }
          ]
        }
      ]
    }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-6xl h-full max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900">AffiliateFlow Tutorials</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-80 border-r border-gray-200 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <h4 className="font-semibold text-gray-900 mb-3">{currentCategory.title}</h4>
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-600 mt-1 line-clamp-2">{tutorial.description}</p>
                        <div className="flex items-center space-x-2 mt-2">
                          <span className="text-xs text-gray-500">{tutorial.duration}</span>
                          <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                          <span className="text-xs text-gray-500 capitalize">{tutorial.type}</span>
                        </div>
                      </div>
                    </div>
                  </button>
              ...
              <>
                ...
                <div className="p-6 border-t border-gray-200 bg-gray-50">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* Video Description */}
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-2">About this tutorial</h4>
                        ...
                        {currentVideo.resources?.map((resource, index) => (
                          ...
                          >
                            <div className="w-8 h-8 bg-gray-100 rounded flex items-center justify-center">
                              ...
                              {resource.type === 'download' && <BookOpen className="w-4 h-4 text-green-600" />}
                              {resource.type === 'article' && <ExternalLink className="w-4 h-4 text-blue-600" />}
                            </div>
                            <div>
...
export const TutorialProgress = ({ userId }) => {
  ...
  const progressPercentage = totalTutorials > 0 ? (completedTutorials / totalTutorials) * 100 : 0;

  return (
    <div className="bg-white rounded-lg shadow p-4">
      <div className="flex items-center justify-between mb-3">
        <h4 className="font-semibold text-gray-900">Tutorial Progress</h4>
        <span className="text-sm text-gray-500">{completedTutorials}/{totalTutorials}</span>
      </div>
